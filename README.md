...
Последняя live-проверка dashboard: 2026-05-27 17:15 UTC. Это snapshot; перед новым upstream comment/PR нужно перепроверить конкретную строку через `gh pr view` / `gh issue view`.
