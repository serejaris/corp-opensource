...
| trycua/cua | [#1724](https://github.com/trycua/cua/issues/1724) | [#32](https://github.com/serejaris/corp-opensource/issues/32), [#52](https://github.com/serejaris/corp-opensource/issues/52), [cycle 8](watch/ai-native-frameworks-scouting-2026-05-27-cycle-8.md), [popular scouting](watch/ai-native-popular-repos-paperclip-scouting-2026-05-27.md) | PR-READY after local macOS repro; duplicate gate clean, but native/AppKit crash evidence must be captured on current `main` | Reproduce `cua-driver mcp` SIGABRT on macOS before any PR |
