...
| langchain-ai/langgraph | [#7688](https://github.com/langchain-ai/langgraph/issues/7688) | [#48](https://github.com/serejaris/corp-opensource/issues/48), [watch](watch/langgraph-7688-timewait-port.md), [cycle 17](watch/ai-native-frameworks-scouting-2026-05-27-cycle-17.md) | WATCH / needs-repro: `langgraph dev` delegates to `langgraph_api.cli.run_server`; port check may live outside open checkout | Inspect `langgraph-api` package source/test surface before any upstream comment/PR |
