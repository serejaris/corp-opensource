...
| `microsoft/playwright-mcp` | 1A | next scout | protocol/tool behavior regressions with tiny fixture; `#1635` first candidate, `#1636` secondary watch | medium-low | browser runtime likely | 2026-05-27 18:18 UTC | separate bounded scouting pass: fresh duplicate search, contribution gate, repo-source location |
