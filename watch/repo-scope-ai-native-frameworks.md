...
| `web-infra-dev/midscene` | `13451` stars, pushed `2026-05-28` | UI automation / browser-use / phone-use framework for agent workflows. Added by [cycle 35](ai-native-popular-repos-paperclip-scouting-2026-05-28-cycle-35-cua-ui-automation.md) as the best new CUA/UI automation `WATCH`; `#2544` longPress cap is the primary runner target, but not a candidate until current-main browser repro proves the contract and duplicate gate stays clean. |
