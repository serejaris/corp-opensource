...
| `stablyai/orca` | `3545` stars, pushed `2026-05-28`; parent count `93` open issues / `133` open PRs on `2026-05-28`; latest `v1.4.30` | Coding-agent IDE/control plane with worktrees, remote SSH and file streaming. Internal `CANDIDATE` after [#82](https://github.com/serejaris/corp-opensource/issues/82) / [watch](orca-2930-short-stream-zero-fill.md): `#2930` short remote stream chunks can zero-fill reads; blocked on Node 24 / pnpm 10 runner fail-before and fresh duplicate gate. |
